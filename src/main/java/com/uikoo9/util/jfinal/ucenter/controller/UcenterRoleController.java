...
import com.uikoo9.util.jfinal.ucenter.service.RoleService;
...
public class UcenterRoleController extends QController{
	...
	public void index(){
		...
		render("/WEB-INF/classes/com/uikoo9/util/jfinal/view/ucenter/ucenter-role-index.ftl");
	}
	...
	public void savep(){
		...
		render("/WEB-INF/classes/com/uikoo9/util/jfinal/view/ucenter/ucenter-role-input.ftl");
	}
	...
	public void setUser(){
		...
		render("/WEB-INF/classes/com/uikoo9/util/jfinal/view/ucenter/ucenter-role-set-user.ftl");
	}
	...
	public void setUrl(){
		...
		render("/WEB-INF/classes/com/uikoo9/util/jfinal/view/ucenter/ucenter-role-set-url.ftl");
	}
