...
public class UcenterMenuController extends QController{
	...
	public void index(){
		...
		render("/WEB-INF/classes/com/uikoo9/util/jfinal/view/ucenter/ucenter-menu-index.ftl");
	}
	...
	public void add(){
		...
		render("/WEB-INF/classes/com/uikoo9/util/jfinal/view/ucenter/ucenter-menu-add.ftl");
	}
	...
	public void savep(){
		...
		render("/WEB-INF/classes/com/uikoo9/util/jfinal/view/ucenter/ucenter-menu-edit.ftl");
	}
